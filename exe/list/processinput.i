#line 1 "app\\ProcessInput\\ProcessInput.c"
...
#line 47 ".\\config\\FreeRTOSConfig.h"

extern uint32_t SystemCoreClock;


 
#line 58 ".\\config\\FreeRTOSConfig.h"

 
#line 66 ".\\config\\FreeRTOSConfig.h"
...
#line 84 ".\\config\\FreeRTOSConfig.h"
...
#line 151 ".\\config\\FreeRTOSConfig.h"
...
#line 152 ".\\os\\include\\FreeRTOS.h"
...
#line 306 ".\\os\\include\\FreeRTOS.h"
...
#line 2 "app\\ProcessInput\\ProcessInput.c"
...
#line 3 "app\\ProcessInput\\ProcessInput.c"
#line 1 "./Sampling_Input.h"
...
#line 5 "./Sampling_Input.h"
#line 6 "./Sampling_Input.h"
#line 7 "./Sampling_Input.h"
#line 8 "./Sampling_Input.h"
...
uint8_t PassengerUP[10U];
uint8_t PassengerDown[10U];

uint8_t DriverUP[10U];
uint8_t DriverDown[10U];
uint8_t DriverLock[10U];

uint8_t OneTouchAllUp[10U];
uint8_t OneTouchAllDown[10U];

uint8_t JamProtection[10U];
uint8_t LimitSwitchUp[10U];
uint8_t LimitSwitchDown[10U];
...
#line 4 "app\\ProcessInput\\ProcessInput.c"
...
void TASK_ProcessInput(void *vptr)
{
    ...
    while (1) {
        ...
        xQueueSemaphoreTake( ( InputDataMutex ), ( ( TickType_t ) 0xffffffffUL ) );
        ...
        xQueueGenericSend( ( QueueHandle_t ) ( InputDataMutex ), 0, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
        ...
        if (JamProtection_State == 1) {
            ...
            if( xQueueGenericSend( ( MovReqQueue ), ( ( void * ) & ProcessInput_movingRequest ), ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) ) != ( ( ( BaseType_t ) 1 ) ) ) {
