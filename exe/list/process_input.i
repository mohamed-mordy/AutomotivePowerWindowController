...
#line 4 "Process_Input.c"
#line 5 "Process_Input.c"
SemaphoreHandle_t MotorMutex = 0;
...
void TASK_ProcessInput(void *pvParameters)
{
    ...
    for(;;) {
				...
				xStatus = xQueueReceive(StateQueue, &Received_State, 100/ ( ( TickType_t ) 1000 / ((TickType_t)1000) ));
        ...
        if (JamProtection_State == 1) {
            ...
            ProcessInput_movingRequest.time = 20 / ( ( TickType_t ) 1000 / ((TickType_t)1000) ); 
            xQueueGenericSend( ( MovReqQueue ), ( ( void * ) & ProcessInput_movingRequest ), ( 0 ), ( ( BaseType_t ) 0 ) );						
						ProcessInput_movingRequest.mode = ON;
						ProcessInput_movingRequest.direction = Down;
						ProcessInput_movingRequest.time = 500 / ( ( TickType_t ) 1000 / ((TickType_t)1000) ); 
