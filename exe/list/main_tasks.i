...
void Task_WND_LS(void *pvParameters)
{
	...
	{
		state = 0;
		if (GPIOPinRead(0x40004000, 0x00000010)) 
		{
			state = 1;
			xStatus = xQueueGenericSend( ( StateQueue ), ( &state ), ( 0 ), ( ( BaseType_t ) 0 ) );			
    }
		else
		{
			state = 0;
		}
		if (GPIOPinRead(0x40004000, 0x00000020))
		{
			state = 2;
			xStatus = xQueueGenericSend( ( StateQueue ), ( &state ), ( 0 ), ( ( BaseType_t ) 0 ) );			
    }
...
void Task_JAM_LS(void *pvParameters)
{
	...
	{
		state = 0;
		if (GPIOPinRead(0x40004000, 0x00000040))
		{
			state = 3;
			xStatus = xQueueGenericSend( ( StateQueue ), ( &state ), ( 0 ), ( ( BaseType_t ) 0 ) );	
...
void Task_PASS_PB(void *pvParameters)
{
	...
	{
		state = 0;
		if (GPIOPinRead(0x40004000 , 0x00000004))
		{
			state = 5;
			xStatus = xQueueGenericSend( ( StateQueue ), ( &state ), ( 0 ), ( ( BaseType_t ) 0 ) );			
    }
		if (GPIOPinRead(0x40004000, 0x00000008))
		{
			state = 6;
			xStatus = xQueueGenericSend( ( StateQueue ), ( &state ), ( 0 ), ( ( BaseType_t ) 0 ) );			
    }
...
void Task_DRVR_PB(void *pvParameters)
{
	...
	{	
		state = 0;
		if (GPIOPinRead(0x40005000, 0x00000008))
		{
			state = 7;
			xStatus = xQueueGenericSend( ( StateQueue ), ( &state ), ( 0 ), ( ( BaseType_t ) 0 ) );			
    }
		...
		if (GPIOPinRead(0x40005000, 0x00000010))
		{
			state = 8;
			xStatus = xQueueGenericSend( ( StateQueue ), ( &state ), ( 0 ), ( ( BaseType_t ) 0 ) );			
    }
...
void Task_DRVR_AUTO(void *pvParameters)
{
	...
	for (;;)
	{
		...
		state = 0;
		if (GPIOPinRead(0x40006000, 0x00000010))
		{
			state = 9;
			xStatus = xQueueGenericSend( ( StateQueue ), ( &state ), ( 0 ), ( ( BaseType_t ) 0 ) );			
    }
		...
		if (GPIOPinRead(0x40006000, 0x00000020))
		{
			state = 10;
			xStatus = xQueueGenericSend( ( StateQueue ), ( &state ), ( 0 ), ( ( BaseType_t ) 0 ) );			
    }
